...
describe('create-post-controller', () => {
  ...
  it('should not be able to create a post if the user is not authenticated', async () => {
    await request(app.getHttpServer())
      .post('/post')
      .send({
        content: null,
  ...
  it('should not be able to create a post without a content', async () => {
    await request(app.getHttpServer())
      .post('/post')
      .send({
        content: null,
  ...
  it('should be able to create a post with success', async () => {
    await request(app.getHttpServer())
      .post('/post')
      .send({
